...
class WebViewAddJavaScriptInterface(categories.ICodeVulnerability):
    def __init__(self):
    ...
    def check_vulnerability(
        ...
        try:
            ...
            # The target method is the addJavascriptInterface WebView API.
            target_methods: List[MethodAnalysis] = []

            for m in dx.get_methods():
                if (
                    m.name == "addJavascriptInterface"
                    and m.descriptor == "(Ljava/lang/Object; Ljava/lang/String;)V"
                ):
                    # Don't match the class name since a subclass of WebView could be
                    # used instead.
