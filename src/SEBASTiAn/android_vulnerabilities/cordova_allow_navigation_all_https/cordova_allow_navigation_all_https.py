...
class CordovaAllowNavigationAllHttps(categories.IHybridAppVulnerability):
    def __init__(self):
    ...
    def check_vulnerability(
        ...
        try:
            ...
            # Check allow-navigation issues:
            for item in tree.findall(".//allow-navigation"):
                if "href" in item.attrib and (
                    item.attrib["href"].strip() == "https://*"
