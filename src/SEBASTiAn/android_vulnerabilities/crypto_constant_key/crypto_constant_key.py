        ...
        if (
            ...
            if isinstance(last_invocation_params[1], str):
                ...
                self.vulnerabilities[
                    ...
                    f'constant key "{last_invocation_params[1]}" parameter passed '
                    "to SecretKeySpec",
                    " --> ".join(
...
class CryptoConstantKey(categories.ICodeVulnerability):
    def __init__(self):
    ...
    def check_vulnerability(
        ...
        try:
            ...
            # The target methods are SecretKeySpec constructors.
